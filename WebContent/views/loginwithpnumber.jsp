...
<body ">
	...
	<center><h1>LOGIN MODULE</h1></center>
	</div>
	<div style="border:1px solid; margin:0% 20%; position:relative; color:black; background-color:pink;">
	<center>
		<h1>LOGIN WITH PHON NUMBER</h1>
		<form method="post" action="LoginWithNumber" enctype="multipart/form-data">
		
			<table border="0">
				<tr>
					<td>Phon No:</td>
					<td><input type="text" name="upnonNo" size="50" /></td>
				</tr>
				<tr>
					<td>password:</td>
