...
<body>
	...
	<div
		...
		<div
			style="border: 1px solid; margin: 0% 20%; position: relative; color: black; background-color: pink;">
			<center>
				...
				<form method="post" action="LoginWithEmailID" enctype="multipart/form-data">
					...
					<table border="0">
						...
						<tr>
							...
							<td>
							<th colspan="2"><a href="loginOption">Login Option !!</a></th></td>
						</tr>
						<tr>
						<td><th colspan="2"><a href="searchyourpwd" >forgot password!!</a></th></td>
						</tr>
